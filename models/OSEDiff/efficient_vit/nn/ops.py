...
class StainAwarePixelUnshuffleDownsample(nn.Module):
    def __init__(self, in_channels, out_channels, factor):
        ...
        self.reduction = nn.Conv2d(in_channels * factor**2, out_channels, kernel_size=1)
...
class StainAwarePixelShuffleUpSample(nn.Module):
    def __init__(self, in_channels, out_channels, factor):
        super().__init__()
        self.in_channels = in_channels
        self.out_channels = out_channels
